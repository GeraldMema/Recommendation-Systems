...
public class RecommenderSystem {
	...
	private static double recommending_percentage = 0.80;
	...
	ClassNotFoundException {
		...
		for (int i = 0; i < users; i++) {
			...
			//kane tis va8mologies tou xrhsth grammika aneksarthtes prokeimenou na mporw na efarmosw grammikh
			//palindromish
			int[][][] upgradedNewdataset = new int[newdataset.length][][];
